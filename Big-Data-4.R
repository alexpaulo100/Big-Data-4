...
setwd("C:/BigDataRAzure/projetosR/Big-Data-4")
getwd()
search()
# Imports
library(tidyverse)
...
# Número de clientes
# Quando nome de coluna estiver com espaço usar aspas simples
length(dataset$`Customer ID`)
# Usar função unique para saber quantos clientes unicos fizeram compras
